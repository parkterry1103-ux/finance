...
function validateConfigInventory(activeConfig: ReleaseGateConfig) {
  ...
  const requiredFiles = [
    ...
    'scripts/investment-thinking-unit.ts',
    ...
    'src/routes/InvestmentCaseRoute.tsx',
    'docs/plans/phase-6a-investment-thinking-lab-plan.html',
    'docs/investment-thinking-lab-model.md',
...
const compiledChecks: Array<[string, string]> = [
  ...
  ['Investment Thinking Lab unit', 'investment-thinking-unit.js'],
