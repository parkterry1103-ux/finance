import skHynix from './audit-entries/sk-hynix.js';
import lgElectronics from './audit-entries/lg-electronics.js';
import nvidia from './audit-entries/nvidia.js';
import micron from './audit-entries/micron.js';
import dell from './audit-entries/dell.js';
