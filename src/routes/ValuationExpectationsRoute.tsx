...
function FullValuation({ report, view, onNavigate }: { report: ResearchReportModel; view: ValuationExpectationView; onNavigate: Props['onNavigate'] }) {
