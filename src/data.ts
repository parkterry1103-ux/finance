...
export const currentWeeklyDigest: WeeklyDigest = {
  ...
  headline: '이번 주 시장은 AI 서버 자금조달, 메모리 반등, 재건 기대, 예측 플랫폼으로 갈렸습니다.',
  subheadline: 'SMCI는 자금조달 부담, Micron은 AI 메모리, 현대건설은 재건 기대, DraftKings는 예측 플랫폼으로 봅니다.',
  sourceNote: '정적 콘텐츠에는 가격·재무 숫자를 만들지 않고, 기준일은 가격 배지와 원문 링크로 확인합니다.',
  featuredPickId: 'pick-smci-ai-server-funding-dilution',
  featured: {
    marketLabel: '미국',
    theme: 'AI 서버',
    question: 'AI 서버 주문은 많은데, 왜 SMCI는 흔들렸을까?',
    meta: 'SMCI · AI 서버 자금조달 부담 · 데이터센터',
    headline: 'AI 서버 수요가 강해도 주가는 무조건 오르지 않습니다.',
    summary: 'AI 서버 주문은 많았지만, 시장이 자금조달과 희석 부담을 어떻게 봤는지 확인합니다.',
    metricLabels: ['주문 -> 매출 전환', '마진', '영업현금흐름'],
    primaryCtaLabel: 'SMCI 해부 보기',
    secondaryCtaLabel: '이번 주 Pick 전체 보기',
  },
  recentItems: [
    {
      id: 'weekly-smci-ai-server-funding-dilution',
      pickId: 'pick-smci-ai-server-funding-dilution',
      market: 'US',
      theme: 'AI 서버',
      movementLabel: 'AI 서버 자금조달 부담',
      question: 'AI 서버 주문은 많은데, 왜 SMCI는 흔들렸을까?',
      summary: 'AI 서버 주문과 대규모 자금조달, 희석 부담을 함께 봅니다.',
      relatedCompanies: ['NVIDIA', 'Micron', 'SK하이닉스'],
    },
    {
      id: 'weekly-micron-ai-memory-hbm-demand',
      pickId: 'pick-micron-ai-memory-hbm-demand',
      market: 'US',
      theme: 'AI 메모리 / HBM',
      movementLabel: 'AI 메모리 반등',
      question: 'AI 서버가 늘면 왜 Micron도 같이 봐야 할까?',
      summary: 'AI 서버 증가가 HBM, DRAM, NAND 같은 고성능 메모리 수요로 이어지는지 봅니다.',
      relatedCompanies: ['NVIDIA', 'SK하이닉스', '삼성전자'],
    },
    {
      id: 'weekly-hyundai-engineering-reconstruction-expectation',
      pickId: 'pick-hyundai-engineering-reconstruction-expectation',
      market: 'KR',
      theme: '재건 / 인프라',
      movementLabel: '중동 재건 기대',
      question: '종전 기대감이 커지면 시장은 왜 건설주를 볼까?',
      summary: '종전 기대가 실제 인프라 발주와 수주로 이어질 수 있는지 봅니다.',
      relatedCompanies: ['삼성물산', 'GS건설', '대우건설'],
    },
    {
      id: 'weekly-draftkings-sports-prediction-platform',
      pickId: 'pick-draftkings-sports-prediction-platform',
      market: 'US',
      theme: '스포츠·예측 플랫폼',
      movementLabel: '예측 플랫폼 성장',
      question: 'DraftKings는 스포츠 관심을 어떻게 돈이 도는 플랫폼으로 바꿀까?',
      summary: '스포츠 관심이 베팅, 예측 거래, 재방문으로 연결되는 플랫폼 구조를 봅니다.',
      relatedCompanies: ['FanDuel', 'Kalshi', 'Polymarket'],
    },
  ],
  marketTabs: [
