...
const aiRelationshipCompanies: Company[] = [
  makeAiRelationshipCompany({
    ...
    businessSummary: '검색, 광고, 클라우드, AI 인프라를 운영하는 플랫폼 기업입니다. AI 인프라 투자를 통해 반도체와 데이터센터 수요를 만듭니다.',
    mainCustomersOrDemand: ['AI 서비스 사용자', 'Google Cloud 고객', '데이터센터 투자'],
    relationshipSummary: 'AI 인프라 투자가 맞춤형 반도체, 네트워크 반도체, 데이터센터 인프라 수요와 연결될 수 있습니다.',
    economicMoat: '검색·광고 데이터, 클라우드 고객 기반, AI 인프라 투자',
    moatExplanation: '사용자 데이터와 클라우드 고객 기반이 크기 때문에 AI 서비스와 인프라 투자를 계속 키울 수 있는 경쟁력으로 볼 수 있습니다.',
    investorWatchPoint: 'AI 인프라 투자 규모가 반도체·네트워크·데이터센터 장비 수요로 이어지는지 봅니다.',
  ...
  makeAiRelationshipCompany({
    ...
    valueChainStage: '최종 수요 / 플랫폼',
    businessSummary: 'Azure 클라우드와 AI 서비스를 운영하는 플랫폼 기업입니다. 데이터센터와 AI 서버 수요를 만드는 기업입니다.',
    mainCustomersOrDemand: ['Azure 고객', 'AI 서비스 수요', '데이터센터 투자'],
    relationshipSummary: 'AI 서비스 확산과 Azure 투자가 GPU, 서버, 전력·냉각 인프라 수요와 연결될 수 있습니다.',
    economicMoat: '클라우드 고객 기반, 엔터프라이즈 소프트웨어, AI 서비스 생태계',
    moatExplanation: '기업 고객이 이미 Microsoft 서비스에 익숙할수록 다른 플랫폼으로 바꾸는 비용이 커질 수 있습니다.',
    investorWatchPoint: 'Azure 성장률과 AI 관련 설비투자가 실제 매출 성장으로 이어지는지 봅니다.',
    relationshipType: '클라우드 고객',
    relationshipConfidence: '산업상 관련',
  ...
  makeAiRelationshipCompany({
    ...
    businessSummary: '네트워크 반도체와 AI 맞춤형 칩 관련 솔루션을 제공하는 기업입니다.',
    mainCustomersOrDemand: ['AI 인프라 투자', '클라우드 데이터센터', '네트워크 장비 수요'],
    relationshipSummary: '클라우드 기업의 AI 인프라 투자가 맞춤형 칩과 네트워크 반도체 수요로 연결될 수 있습니다.',
    economicMoat: '네트워크 칩 설계 경험, 고객 맞춤형 ASIC 역량, 장기 고객 관계',
    moatExplanation: '고객 맞춤형 칩은 설계 기간과 검증 과정이 길어 한 번 채택되면 바꾸기 어려운 진입장벽이 될 수 있습니다.',
    investorWatchPoint: 'AI ASIC 매출 성장과 고객 집중 리스크를 함께 확인합니다.',
  ...
  makeAiRelationshipCompany({
    ...
    businessSummary: 'NVIDIA, AMD, Broadcom 같은 설계 기업의 첨단 칩을 대신 생산하는 파운드리 기업입니다.',
    mainCustomersOrDemand: ['AI 칩 설계 기업', '팹리스 반도체 기업', '첨단 공정 수요'],
    relationshipSummary: 'AI 칩 설계 기업의 수요가 첨단 파운드리 생산 수요와 연결됩니다.',
    economicMoat: '첨단 공정 기술, 대규모 생산 경험, 고객 신뢰',
    moatExplanation: '고성능 칩을 안정적으로 대량 생산할 수 있는 기업이 많지 않아 대체가 어렵습니다.',
    investorWatchPoint: '첨단 공정 가동률, AI 고객 수요, 설비투자 계획을 함께 봅니다.',
  ...
  makeAiRelationshipCompany({
    ...
    businessSummary: 'HBM, DRAM, NAND 같은 메모리 반도체를 만드는 기업입니다. AI 서버용 HBM 수요와 연결됩니다.',
    mainCustomersOrDemand: ['AI GPU 생태계', 'AI 서버 수요', '고성능 메모리 수요'],
    relationshipSummary: 'AI GPU 수요가 늘면 GPU에 필요한 HBM 수요도 함께 커질 수 있습니다.',
    economicMoat: 'HBM 생산 경험, 고성능 메모리 기술',
    moatExplanation: 'AI 서버에 필요한 고성능 메모리는 품질과 양산 경험이 중요합니다.',
    investorWatchPoint: 'HBM 매출 확대가 실제 현금흐름과 마진 개선으로 이어지는지 봅니다.',
  ...
  makeAiRelationshipCompany({
    ...
    valueChainStage: '메모리 / HBM',
    businessSummary: '메모리 반도체, 파운드리, 스마트폰 등을 만드는 글로벌 제조 기업입니다.',
    mainCustomersOrDemand: ['AI 서버 메모리 수요', '파운드리 고객', '스마트폰 수요'],
    relationshipSummary: 'AI 서버 수요는 메모리와 파운드리 투자 흐름과 함께 봐야 합니다.',
    economicMoat: '메모리 양산 경험, 제조 규모, 파운드리 기술',
    moatExplanation: '대규모 반도체 생산 경험과 고객 인증은 진입장벽이 될 수 있습니다.',
    investorWatchPoint: 'HBM 경쟁력, 파운드리 가동률, 메모리 가격 사이클을 함께 봅니다.',
    relationshipType: '메모리 / HBM',
    relationshipConfidence: '산업상 관련',
    sourceDirectUrl: 'https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20260515002181',
    reportUrl: 'https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20260515002181',
  ...
  makeAiRelationshipCompany({
    ...
    valueChainStage: '메모리 / HBM',
    businessSummary: 'DRAM, NAND, HBM 같은 메모리 반도체를 만드는 미국 기업입니다.',
    mainCustomersOrDemand: ['AI 서버 수요', '데이터센터 메모리 수요'],
    relationshipSummary: 'AI 서버와 GPU 수요는 고성능 메모리 수요와 연결됩니다.',
    economicMoat: '메모리 생산 경험, 고성능 메모리 기술',
    moatExplanation: '메모리 반도체는 양산 품질과 원가 경쟁력이 중요해 경험이 경쟁력으로 볼 수 있습니다.',
    investorWatchPoint: 'HBM 전환 속도와 메모리 가격 회복이 실적에 반영되는지 봅니다.',
    relationshipType: '메모리 / HBM',
    relationshipConfidence: '산업상 관련',
  ...
  makeAiRelationshipCompany({
    ...
    businessSummary: '첨단 반도체 생산에 필요한 EUV 노광장비를 만드는 기업입니다.',
    mainCustomersOrDemand: ['첨단 파운드리', '메모리 제조사', '반도체 설비투자'],
    relationshipSummary: '첨단 반도체 제조에는 ASML의 EUV 노광장비 같은 핵심 장비가 필요합니다.',
    economicMoat: 'EUV 노광장비 기술',
    moatExplanation: '첨단 반도체 생산에 필요한 핵심 장비를 만들 수 있는 기업이 극히 제한적입니다.',
    investorWatchPoint: 'EUV 수주, 고객 설비투자, 장비 인도 지연 여부를 봅니다.',
  ...
  makeAiRelationshipCompany({
    ...
    businessSummary: '데이터센터 전력·냉각 인프라를 제공하는 기업입니다.',
    mainCustomersOrDemand: ['AI 데이터센터', '전력·냉각 증설 수요'],
    relationshipSummary: 'AI 서버 수요가 늘면 데이터센터 전력·냉각 인프라 수요도 함께 커질 수 있습니다.',
    economicMoat: '데이터센터 전력·냉각 운영 경험',
    moatExplanation: '데이터센터는 안정성이 중요해서 검증된 인프라 기업을 선호할 수 있습니다.',
    investorWatchPoint: '전력·냉각 수주와 마진이 AI 데이터센터 투자와 함께 늘어나는지 봅니다.',
...
const companyRelationshipOverrides: Record<string, Partial<Company>> = {
  'us-semiconductors-nvidia': {
    ...
    businessSummary: 'AI 계산에 필요한 GPU와 AI 가속기를 설계하는 기업입니다. AI 서버 수요를 볼 때 가장 먼저 확인하는 대표 기업입니다.',
    ...
    relationshipSummary: 'AI 서비스와 데이터센터 투자가 늘면 GPU, HBM, 서버, 전력·냉각 인프라 수요와 함께 움직일 수 있습니다.',
    customerExposure: '주요 고객과 매출 비중은 공식 공시·IR 기준으로 확인합니다.',
    revenueExposure: '데이터센터 매출 비중은 공시 원문에서 확인하고, 고객별 비중은 공개 범위를 확인해야 합니다.',
    moat: 'GPU 생태계, 소프트웨어 플랫폼, 고객 락인',
    economicMoat: 'GPU 생태계, 소프트웨어 플랫폼, 고객 락인',
    moatExplanation: 'AI 개발자와 기업들이 NVIDIA 생태계에 익숙해질수록 다른 제품으로 바꾸기 어려워질 수 있습니다.',
    investorWatchPoint: '데이터센터 매출 성장, HBM 공급, 고객 설비투자, 마진을 함께 봅니다.',
    relationshipType: 'AI 칩 / GPU',
    relationshipConfidence: '공시·IR 기준',
