...
export const currentWeeklyDigest: WeeklyDigest = {
  ...
  headline: '이번 주 시장은 합병 교환조건과 FDA 규제 경로에 크게 반응했습니다.',
  subheadline: 'Huntsman은 전액 주식 합병의 교환가치, uniQure는 AMT-130의 BLA 제출 가능성을 봅니다.',
  sourceNote: '정적 콘텐츠에는 가격·재무 숫자를 만들지 않고, 기준일은 가격 배지와 원문 링크로 확인합니다.',
  featuredPickId: 'pick-huntsman-olin-merger-exchange-ratio',
  featured: {
    marketLabel: '미국',
    theme: 'M&A / 합병 조건',
    question: 'M&A 뉴스가 나왔는데 Huntsman 주가는 왜 빠졌을까요?',
    meta: 'HUN · NYSE · Olin 전액 주식 합병',
    headline: '합병 발표가 나와도 교환조건이 낮게 평가되면 주가는 하락할 수 있습니다.',
    summary: 'Huntsman 1주당 Olin 0.5476주라는 교환비율과 발표 전일의 참고 합병가치를 확인합니다.',
    metricLabels: ['교환비율 0.5476', '2027년 상반기', '발표일 약 -17.1%'],
    primaryCtaLabel: 'Huntsman 해부 보기',
    secondaryCtaLabel: '이번 주 Pick 전체 보기',
  },
  recentItems: [
    {
      id: 'weekly-huntsman-olin-merger-exchange-ratio',
      pickId: 'pick-huntsman-olin-merger-exchange-ratio',
      market: 'US',
      theme: 'M&A / 합병 조건',
      movementLabel: '합병 발표 / 약 17.1% 하락',
      question: 'M&A 뉴스가 나왔는데 Huntsman 주가는 왜 빠졌을까요?',
      summary: 'Olin 0.5476주 교환비율과 주주·규제 승인, 화학 업황을 함께 봅니다.',
      relatedCompanies: ['Olin', 'Huntsman 주주', 'Olin 주주'],
    },
    {
      id: 'weekly-uniqure-amt130-fda-regulatory-path',
      pickId: 'pick-uniqure-amt130-fda-regulatory-path',
      market: 'US',
      theme: '바이오 / FDA 규제 경로',
      movementLabel: 'FDA 경로 재개 / 약 78.4% 상승',
      question: '신약이 승인된 것도 아닌데 uniQure 주가는 왜 급등했을까요?',
      summary: 'AMT-130의 3년차 데이터를 BLA 근거로 검토할 길이 열렸지만 승인 완료는 아닙니다.',
      relatedCompanies: ['FDA', 'AMT-130', '확증시험'],
    },
  ],
  marketTabs: [
    { id: 'ALL', label: '전체' },
