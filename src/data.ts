...
export const stockAutopsyPicks: StockAutopsyPick[] = [
  ...
  },
  {
    ...
    movementDirection: 'up',
    movementLabel: '실적 / 급등',
    reasonSummary: 'AI가 커질수록 기업 데이터 정리와 연결이 중요해지면서 데이터 플랫폼 기대감이 커졌습니다.',
...
export const currentWeeklyDigest: WeeklyDigest = {
  weekLabel: '2026년 5월 마지막 주',
  kicker: '2026년 5월 마지막 주 해부',
  headline: 'AI 인프라가 서버, 데이터, 메모리로 넓어지는 흐름을 정리했습니다.',
  subheadline: 'Dell, Snowflake, Micron을 통해 이번 주 AI 인프라 흐름을 카드형으로 봅니다.',
  sourceNote: 'SEC/OpenDART 원문 숫자로 마지막에 확인합니다.',
  featuredPickId: 'pick-dell-ai-server-earnings-check',
  featured: {
    marketLabel: '미국',
    theme: 'AI 서버',
    question: 'Dell은 왜 또 급등했을까?',
    meta: 'DELL · 실적 / 급등 · AI 서버',
    headline: '지난번에는 AI 서버 기대감이었고, 이번에는 주문·매출·가이던스 숫자로 확인됐습니다.',
    summary: '기대감이 실제 숫자로 이어지는지 봅니다.',
    metricLabels: ['매출', 'AI 서버 주문 / 백로그', '가이던스'],
    primaryCtaLabel: '1분 흐름 보기',
    secondaryCtaLabel: '최근 해부 보기',
  },
  recentItems: [
    {
      id: 'weekly-dell-ai-server-earnings-check',
      pickId: 'pick-dell-ai-server-earnings-check',
      market: 'US',
      theme: 'AI 서버',
      movementLabel: '실적 / 급등',
      question: 'Dell은 왜 또 급등했을까?',
      summary: '지난번에는 AI 서버 기대감이었고, 이번에는 주문·매출·가이던스 숫자로 확인됐습니다.',
      relatedCompanies: ['NVIDIA', 'Super Micro', 'Vertiv'],
    },
    {
      id: 'pick-snowflake-ai-data-platform',
      ...
      theme: 'AI 데이터 플랫폼',
      movementLabel: '실적 / 급등',
      question: 'Snowflake는 왜 폭등했을까?',
      summary: 'AI가 커질수록 기업 데이터 정리와 연결이 중요해지면서 데이터 플랫폼 기대감이 커졌습니다.',
      relatedCompanies: ['Amazon / AWS', 'Microsoft', 'Datadog'],
    },
    {
      id: 'weekly-micron-ai-memory-hbm',
      companyId: 'ai-datacenter-micron',
      market: 'US',
      theme: 'AI 메모리 / HBM',
      movementLabel: '급등',
      question: 'Micron은 왜 급등했을까?',
      summary: 'AI 서버가 늘수록 GPU 옆의 메모리 수요도 커지고, HBM 공급 부족 기대가 주가를 밀어 올렸습니다.',
  ...
  marketMapItems: [
    ...
    },
    {
      ...
      href: '/ko/category/us-semiconductors',
      sectorId: 'us-semiconductors',
      note: 'Dell, Super Micro, Vertiv로 이어지는 서버 인프라',
    },
    {
      title: 'AI 메모리 / HBM',
      status: 'active',
      href: '/ko/category/us-semiconductors',
      sectorId: 'us-semiconductors',
      note: 'Micron, SK하이닉스, 삼성전자와 연결되는 메모리 흐름',
    },
    {
      title: '데이터센터 인프라',
      status: 'active',
      href: '/ko/category/us-semiconductors',
      sectorId: 'us-semiconductors',
      note: 'GPU, 서버, 전력·냉각을 함께 보는 기존 지도',
    },
    { title: 'AI 데이터 플랫폼', status: 'coming-soon', note: 'Snowflake, 클라우드, 데이터 관측성 흐름' },
