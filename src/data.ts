...
export const currentWeeklyDigest: WeeklyDigest = {
  ...
  headline: '이번 주 AI 인프라는 서버, 데이터, 메모리로 나뉘어 움직였습니다.',
  subheadline: 'Dell은 서버 숫자, Snowflake는 데이터 플랫폼, Micron은 HBM 메모리로 봅니다.',
  sourceNote: '숫자는 SEC/OpenDART 원문 기준으로만 확인합니다.',
  ...
  featured: {
    ...
    headline: 'AI 서버 기대가 주문·매출·가이던스로 확인됐는지 봅니다.',
    summary: '기대에서 숫자 확인으로 넘어간 후속편입니다.',
    metricLabels: ['매출', 'AI 서버 주문 / 백로그', '가이던스'],
    primaryCtaLabel: 'Dell 해부 보기',
  ...
  recentItems: [
    {
      ...
      movementLabel: '실적 / 급등',
      question: 'Dell은 왜 또 급등했을까?',
      summary: '주문·백로그가 매출, 마진, 전망으로 이어지는지 봅니다.',
      relatedCompanies: ['NVIDIA', 'Super Micro', 'Vertiv'],
    },
    {
      id: 'pick-snowflake-ai-data-platform',
      ...
      summary: 'AI 기능이 기업 데이터 정리와 사용량 증가로 이어지는지 봅니다.',
    ...
    },
    {
      ...
      summary: 'AI 서버 확대로 HBM·고성능 메모리 수요가 커지는지 봅니다.',
