...
export const currentWeeklyDigest: WeeklyDigest = {
  ...
  featured: {
    ...
    headline: 'AI 서버 기대가 주문·매출·가이던스로 확인되는지 봅니다.',
    summary: '기대에서 실적으로 넘어간 후속편입니다.',
    metricLabels: ['매출', 'AI 서버 주문 / 백로그', '가이던스'],
    primaryCtaLabel: '대표 해부 보기',
  ...
  recentItems: [
    {
      ...
      movementLabel: '실적 / 급등',
      question: 'Dell은 왜 또 급등했을까?',
      summary: '주문과 백로그가 매출, 마진, 다음 전망으로 이어지는지 확인합니다.',
      relatedCompanies: ['NVIDIA', 'Super Micro', 'Vertiv'],
    },
    {
      id: 'pick-snowflake-ai-data-platform',
    ...
    },
    {
      ...
      summary: 'AI 서버가 늘수록 GPU 옆의 메모리 수요도 커지고, HBM 공급 부족 기대가 함께 주목받았습니다.',
